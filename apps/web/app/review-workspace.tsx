      ...
      <section className="hero-panel">
        <div className="hero-copy">
          ...
          <p className="hero-text">
            Manage matters, upload support documents, inspect cited findings, and keep a lightweight web-side view of document status.
          </p>
        ...
        <div className="panel issue-panel">
          <div className="panel-header">
            <div>
              ...
              <h2>Findings with source anchors</h2>
            </div>
