      ...
      <div className="action-card">
        ...
        <form className="inline-form" onSubmit={handleCreateWorkspace}>
          <input
            ...
            placeholder="Maple SaaS Agreement Review"
            value={workspaceName}
          />
      ...
      <div className="action-card">
        ...
        <p className="muted-text small-text">
          {isDemoWorkspace
            ...
            : "Upload PDF and DOCX files when you need a support-side copy outside Word."}
        </p>
      </div>
